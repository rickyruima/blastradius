...
Add to your workflow to automatically check Terraform plans on PRs:
...
jobs:
  blast-radius:
    ...
    steps:
      ...
      - uses: rickyruima/blastradius/.github/actions/blastradius@main
        with:
          plan-file: plan.json
          threshold: high
```
...
| `version` | BlastRadius version to install | `latest` |
...
See [ACTION_README.md](ACTION_README.md) for full details.
